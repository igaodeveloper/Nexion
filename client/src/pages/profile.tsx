  ...
  return (
    <AppLayout>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="space-y-4 max-w-xl">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center">
                  ...
                  <button 
                    ...
                    onClick={() => handleFieldEdit("firstName", user?.firstName || "")}
                  >
              ...
              <div className="flex justify-between items-center border-t border-gray-200 pt-4">
                ...
                <div className="flex items-center">
                  ...
                  <button 
                    className="text-primary hover:text-primary-dark"
                    onClick={() => handleFieldEdit("lastName", user?.lastName || "")}
                  >
                    <Pencil className="h-4 w-4" />
                  </button>
                </div>
              ...
              <div className="flex justify-between items-center border-t border-gray-200 pt-4">
                ...
                <div className="flex items-center">
                  ...
                  <button 
                    className="text-primary hover:text-primary-dark"
                    onClick={() => handleFieldEdit("username", user?.username || "")}
                  >
                    <Pencil className="h-4 w-4" />
                  </button>
                </div>
        ...
        {activeTab === "security" && (
          <div className="p-6">
            <form className="space-y-4 max-w-xl" onSubmit={handleSubmit(onPasswordChangeSubmit)}>
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">Mostrar senha (Alt + F6)</p>
              </div>
                    ...
                    {sessions?.map((session) => {
                      ...
                      return (
                        <tr key={session.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{session.location || "Desconhecido"}</td>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button className="text-primary hover:text-primary-dark">Sair</button>
                          </td>
                        </tr>
                      );
                    })}
