...
import { BarChart, LineChart, Bar, Area, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, PieChart, Pie, Cell } from "recharts";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Button } from "@/components/ui/button";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { CalendarIcon, DownloadIcon, FilterIcon, BarChart2Icon, PieChartIcon, TrendingUpIcon } from "lucide-react";
      ...
      <div className="flex flex-col space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Visualize o desempenho da sua equipe e projetos.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+2.4% em relação ao mês anterior</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Total de tarefas concluídas vs pendentes por mês</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Taxa de eficiência por departamento</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Legend />
                    <Bar dataKey="efficiency" name="Eficiência (%)" fill="hsl(var(--chart-1))" radius={[0, 4, 4, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Horas por dia e tipo de atividade</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Legend />
                    <Line type="monotone" dataKey="design" name="Design" stroke="#6366F1" activeDot={{ r: 8 }} />
                    <Line type="monotone" dataKey="development" name="Desenvolvimento" stroke="#10B981" />
                    <Line type="monotone" dataKey="planning" name="Planejamento" stroke="#F59E0B" />
                    <Line type="monotone" dataKey="meetings" name="Reuniões" stroke="#F43F5E" />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
