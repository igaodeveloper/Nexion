...
export default function DocumentPage() {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: async (data, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: ["/api/documents", parseInt(id!)],
      });
    },
    onError: (error) => {
      toast({
  ...
  if (!id && !showTemplateGallery) {
    ...
    return (
      <div
        className="flex flex-col min-h-screen bg-background editor-content"
          ...
          <div className="flex items-center gap-2">
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>Escolha um modelo pré-definido</TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          <div className="sticky top-0 z-10 flex items-center justify-between p-4 bg-background/80 backdrop-blur-sm border-b">
            <div className="flex items-center">
              ...
              <div className="hidden sm:flex items-center space-x-1">
                ...
                <Badge
                  variant={
                    documentPermission === "private" ? "secondary" : "outline"
                  }
                  className="text-xs"
                >
                  ...
                  if (document) {
                    const currentPage: Page = {
                      ...
                      blocks: document.blocks
                        ? JSON.parse(document.blocks as string)
                        : [],
                      emoji: document.emoji,
                      coverImage: document.coverImage,
                      isFavorite: document.isFavorite,
