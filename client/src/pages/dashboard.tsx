...
const tasks = [
  {
    ...
    priority: "high",
    dueDate: "2023-08-15",
    assignee: "Carolina Silva",
  },
  {
    id: 2,
    title: "Otimização do banco de dados",
    status: "pending",
    priority: "medium",
    dueDate: "2023-08-18",
  ...
  {
    id: 3,
    title: "Integração com a API de pagamentos",
    status: "complete",
    priority: "high",
    dueDate: "2023-08-10",
    assignee: "Matheus Oliveira",
  },
  {
    id: 4,
...
const activities = [
  ...
  },
  {
    ...
    target: "Redesign da página inicial",
    time: "4 horas atrás",
  },
  {
    user: "Juliana Costa",
  ...
  },
  {
    ...
    target: "UI Design Guidelines",
    time: "ontem",
  },
  {
    user: "Matheus Oliveira",
    action: "resolved issue",
    target: "API integration bug",
    time: "2 dias atrás",
  },
];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Bem-vindo ao Nexion, sua central de produtividade.
              </p>
            </div>
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {project.tasks.completed} de {project.tasks.total}{" "}
                              tarefas concluídas
                            </p>
                          </div>
            ...
            <div className="lg:col-span-2">
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardDescription>Atividades da sua equipe</CardDescription>
                </CardHeader>
