  ...
  const features = [
    {
      ...
      description:
        "Dashboards interativos e relatórios detalhados para acompanhar o progresso do seu projeto.",
    },
    {
      icon: <Users className="w-12 h-12 text-indigo-500" />,
      title: "Gerencie sua equipe",
      description:
        "Organize e acompanhe as atividades da sua equipe com facilidade e eficiência.",
    },
    {
      icon: <CalendarRange className="w-12 h-12 text-indigo-500" />,
      title: "Agende suas atividades",
      description:
        "Planeje e organize todas as suas tarefas e eventos importantes em um calendário intuitivo.",
    },
    {
      icon: <MessageSquare className="w-12 h-12 text-indigo-500" />,
      title: "Comunique-se facilmente",
      description:
        "Mantenha sua equipe conectada com mensagens instantâneas e compartilhamento de arquivos.",
    },
  ];
              ...
              {currentScreen === 0 && (
                ...
                >
                  <h1 className="text-4xl md:text-5xl font-bold text-foreground">
                    Bem-vindo ao{" "}
                    <span className="text-indigo-600 bg-gradient-to-r from-indigo-600 to-primary bg-clip-text text-transparent">
                      Nexion
                    </span>
                  </h1>
                  <p className="text-xl text-muted-foreground">
                    Sua plataforma completa para gerenciamento de projetos e
                    equipes com uma experiência moderna e intuitiva.
                  </p>
                  <div className="pt-4">
                    <Button
                      size="lg"
              ...
              >
                <div className="relative w-full h-full overflow-hidden rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-xl">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src =
                        "https://placehold.co/600x400/6366f1/white?text=Nexion+Feature";
                    }}
                  />
