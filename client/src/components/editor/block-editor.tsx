...
export default function BlockEditor({
  ...
  const [smartLinkPosition, setSmartLinkPosition] = useState({
    top: 0,
    left: 0,
  });
  ...
  const blockTypeOptions = [
    ...
    },
    {
      type: "heading-1",
      label: "Heading 1",
      icon: <Heading1 className="h-4 w-4 mr-2" />,
    },
    {
      type: "heading-2",
      label: "Heading 2",
      icon: <Heading2 className="h-4 w-4 mr-2" />,
    },
    {
      type: "heading-3",
      label: "Heading 3",
      icon: <Heading3 className="h-4 w-4 mr-2" />,
    },
    {
      type: "bullet-list",
      label: "Bullet List",
  ...
  const renderBlock = (block: Block, index: number) => {
    ...
    return (
      ...
      >
        ...
        {!readOnly && showAddButton === block.id && (
          <div className="absolute left-1/2 transform -translate-x-1/2 -top-3 opacity-0 group-hover:opacity-100 transition-opacity">
            <Button
              variant="ghost"
              size="icon"
