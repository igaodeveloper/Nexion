...
export function Sidebar({ companyName, className }: SidebarProps) {
  ...
  const sidebarClass = cn(
    "h-screen overflow-hidden z-20 transition-all duration-300 ease-in-out flex flex-col sidebar",
    collapsed ? "collapsed" : "",
  ...
  const linkItemClass = (active: boolean) =>
    cn(
  ...
  return (
    <div className={sidebarClass}>
      ...
      {/* Main Navigation */}
      <nav className="mt-1 px-2 overflow-y-auto flex-1 pb-5 custom-scrollbar">
              ...
              <TooltipTrigger asChild>
                <Link href="/tasks">
                  <div className={linkItemClass(isActive("/tasks"))}>
                    <CheckSquare
                      className={cn(iconClass, collapsed ? "" : "mr-3")}
                    />
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link href="/messages">
                  <div
                    className={cn(
                      linkItemClass(isActive("/messages")),
                      "relative",
                    )}
                  >
                    <MessageCircle
                    ...
                    {collapsed && (
                      <Badge
                        variant="outline"
                        className="absolute -top-1 -right-1 bg-white/20 text-white text-xs h-5 w-5 flex items-center justify-center"
                      >
                        3
                      </Badge>
                    )}
              ...
              {collapsed && (
                <TooltipContent side="right">Mensagens (3)</TooltipContent>
              )}
            </Tooltip>
          </TooltipProvider>
                  ...
                  <Link href="/workspace/development">
                    <div
                      className={cn(
                        "py-1.5 px-3 text-sm rounded-md",
                        "text-white/70 hover:text-white hover:bg-white/10 transition-colors cursor-pointer",
                        isActive("/workspace/development") &&
                          "bg-white/15 text-white",
                      )}
                    >
                      Development
            ...
            <div className="flex-1 min-w-0">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <p className="text-xs text-white/70 hover:text-white cursor-pointer">
                    Ver perfil
                  </p>
                </DropdownMenuTrigger>
