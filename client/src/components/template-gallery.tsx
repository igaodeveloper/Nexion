...
import { Search, Star, FileText, Database, Calendar, BarChart } from 'lucide-react';
...
export function TemplateGallery({ onSelectTemplate }: TemplateGalleryProps) {
  ...
  const templates: Template[] = [
    ...
    },
    {
      ...
      description: 'Capture notas, decisões e próximos passos durante reuniões.',
      category: 'note',
      thumbnail: 'https://www.notion.so/images/page-cover/met_william_morris_1877_willow.jpg'
    },
    {
      id: 'project-plan',
    ...
    },
    {
      ...
      category: 'personal',
      thumbnail: 'https://www.notion.so/images/page-cover/met_william_morris_1875_marigold.jpg'
    }
  ];
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="hidden md:block w-64 border-r p-4 overflow-auto">
          ...
          <div className="space-y-2">
            ...
            <h3 className="text-sm font-medium text-muted-foreground mt-4 mb-2">Categorias</h3>
